...
@Mapper
public interface UnloadingTableMapper extends BaseMapper<UnloadingTable> {

    /**
     * 删除表
     * */
    @Update("DROP TABLE IF EXISTS unloading_table;")
    int dropTable();

    /**
     * 创建表
     * */
    @Update("CREATE TABLE unloading_table\n" +
            "(\n" +
     ...
     * 批量插入
     * */
    int batchInsert(List<UnloadingTable> list);
}
