...
//        System.out.println(map.get("code"));
        ...
        DataSourceDo d = new DataSourceDo();
        d.setUrl("jdbc:mysql://59.110.34.218:3306?a");
        d.setUsername("root");
        d.setPassword("tsytyyty032269");
        d.setDbName("a");
        d.setType("mysql");
        d.setName("mysqlTest");
        Map<String, String> dataAndType = new HashMap<>();
        ...
        dataAndType.put("unloading_table", "UnloadingTable");
        dataAndType.put("logistics_information", "LogisticsInformation");
        d.setDataAndType(dataAndType);
        Result result = dataSourceController.addDataSource(DtoUtil.DataSourceDoToDto(d));
