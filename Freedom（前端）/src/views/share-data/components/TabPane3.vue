...
export default {
  ...
  methods: {
    ...
    getTotal(){
      axios.post(`http://59.110.34.218:10010/displayData/errorTotal?type=unloading`).then(
        response => {
    ...
    getList() {
      axios.post(`http://59.110.34.218:10010/displayData/unloading?page=${this.currentPage1}&number=20`).then(
        response => {
